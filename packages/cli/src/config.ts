...
export const ConfigSchema = z.object({
  ...
  raceConditions: z.union([
    z.boolean().transform((b) => ({ enabled: b })),
    z.object({
      enabled: z.boolean().optional(),
  ...
  crossUser: z.union([
    z.boolean().transform((b) => (b
      ? {}
      : { crossRoleProbeEnabled: false, anonymousProbeEnabled: false })),
    z.object({
