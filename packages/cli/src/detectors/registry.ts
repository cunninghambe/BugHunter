...
export const DETECTOR_REGISTRY: readonly DetectorRegistryEntry[] = [
  ...
  },
  {
    ...
    specReference: 'SPEC_V06_PERFORMANCE.md',
    defaultSeverity: 'major',
    note: 'Deferred: request-hygiene classifier has no production caller; HAR stream is not piped into the classifier in the execute pipeline. Prerequisite: audit fix #6 (HAR pipeline). See SWEEP_AUDIT_2026-05-03.md.',
  },
  {
