#!/usr/bin/env bash
# command-injection-mini — up.sh
# INTENTIONALLY VULNERABLE fixture for command_injection detector calibration.
...
log() { echo "[command-injection-mini/up.sh] $*" >&2; }
...
wait_for_port "$PORT" "command-injection-mini"
