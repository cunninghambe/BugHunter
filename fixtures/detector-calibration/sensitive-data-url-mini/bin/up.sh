#!/usr/bin/env bash
# sensitive-data-url-mini — up.sh
# Starts the minimal Express server that plants sensitive parameters in URLs.
...
log() { echo "[sensitive-data-url-mini/up.sh] $*" >&2; }
...
wait_for_port "$PORT" "sensitive-data-url-mini"
