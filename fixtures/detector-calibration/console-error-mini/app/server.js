...
// See ../_bh-bootstrap.js for the shared source and rationale.
const { BOOTSTRAP_SOURCE } = require('../../_bh-bootstrap.js');

function html(body) {
  return `<!doctype html><html><head><meta charset="utf-8"><title>console-error</title><script>${BOOTSTRAP_SOURCE}</script></head><body>${body}</body></html>`;
}
